 ...
 *     description: Public requests return published series / shows only. Admin requests with a Bearer token return non-archived content by default and may filter by status, including archived.
 *     tags: [Episodes]
 *     security:
 *       - bearerAuth: []
 *       - {}
